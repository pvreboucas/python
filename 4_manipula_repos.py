#classe chamada no arquivo 4_requests.ipynb
import requests
import base64
...
class ManipulaRepositorios:
    ...
    def deleta_repo(self, nome_repo):
...
novo_repo = ManipulaRepositorios('pvreboucas')
...
novo_repo.add_arquivo(nome_repo, '4_linguagens_amzn.csv', 'Dados/4_linguagens_amzn.csv')
novo_repo.add_arquivo(nome_repo, '4_linguagens_netflix.csv', 'Dados/4_linguagens_netflix.csv')
novo_repo.add_arquivo(nome_repo, '4_linguagens_spotify.csv', 'Dados/4_linguagens_spotify.csv')

# Apagando o repositório
novo_repo.deleta_repo('linguagens-repositorios-empresas')