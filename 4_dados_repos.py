...
# Salvando os dados 
ling_mais_usadas_amzn.to_csv('Dados/4_linguagens_amzn.csv')
ling_mais_usadas_netflix.to_csv('Dados/4_linguagens_netflix.csv')
ling_mais_usadas_spotify.to_csv('Dados/4_linguagens_spotify.csv')